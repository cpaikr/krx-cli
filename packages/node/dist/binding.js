...
import { KrxError, internalFailure } from "./errors.js";
...
export function binding(target = nativeTarget()) {
  if (target === undefined || target === null) {
    throw new KrxError({
      ...
      message: "this platform has no supported krx native artifact",
      retryable: false,
    });
  }
  ...
  try {
    ...
    throw internalFailure(
      "the matching krx native binding could not be loaded",
    );
  }
}
