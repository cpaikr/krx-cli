...
- --verbose 옵션 구현으로 디버깅 로그 지원 ([181f4fc](https://github.com/cpaikr/krx-cli/commit/181f4fcfb23902727b2f1420a3654e0c34bc3fe8))
- 31개 엔드포인트 응답 필드 스키마 추가 ([6f77f18](https://github.com/cpaikr/krx-cli/commit/6f77f18c2fe494020a05caa5e2b0815cca335084))
...
- csv 출력 포맷 및 파일 저장 기능 추가 (-o csv, --save) ([71fe66e](https://github.com/cpaikr/krx-cli/commit/71fe66e6ffc917e098c05e36f64f4301f1b1b2c3))
...
- KRX CLI 초기 프로젝트 설정 및 Phase 1 구현 ([df197ba](https://github.com/cpaikr/krx-cli/commit/df197ba1ff7df830976da59fae6fce32bccbfc0e))
- mcp 리소스 지원 추가 (krx://watchlist, rate-limit, service-status) ([9901763](https://github.com/cpaikr/krx-cli/commit/99017634e5cd0486f4e43c389893e1cf93777402))
- mcp 서버 추가 (claude desktop / chatgpt desktop 지원) ([2417b2d](https://github.com/cpaikr/krx-cli/commit/2417b2d75d88ddaf70a2409b6af2e767f4a07dd3))
...
- Phase 2 구현 - 전체 카테고리 명령어 + rate limit 추적 ([dee5c96](https://github.com/cpaikr/krx-cli/commit/dee5c9670df495ca4ce2c6ab5089c18093c4803d))
...
- skill.md 트리거 조건 추가 및 release-it 버전 동기화 ([7e98f19](https://github.com/cpaikr/krx-cli/commit/7e98f191dfb621b692966a2ab047b7ac40d2b745))
...
- streamable HTTP MCP 서버 추가 (krx serve) ([b71f0cc](https://github.com/cpaikr/krx-cli/commit/b71f0ccd891f2425e3a663de335c074cee55fff2))
- tool result truncation 및 offset 페이지네이션 추가 ([5d773c5](https://github.com/cpaikr/krx-cli/commit/5d773c5d726c82ac156267e1f6911c89027ff16e))
- version 확인 및 update 명령어 추가 ([83bb81a](https://github.com/cpaikr/krx-cli/commit/83bb81a25f41c825392365579737bc8127aab178))
- 기간 조회 기능 추가 (--from/--to) ([9f724d2](https://github.com/cpaikr/krx-cli/commit/9f724d252f01eecbe4f7a3024fac287c19681f0f))
- 네트워크 에러 자동 재시도 기능 추가 (--retries) ([34de501](https://github.com/cpaikr/krx-cli/commit/34de501b224dd05622126904a86f5771b80f9c0f))
- 시장 요약 커맨드 및 문서 업데이트 ([6b9f084](https://github.com/cpaikr/krx-cli/commit/6b9f0844c9b3faadf4e85eb588b5daec9de1bfaa))
- 워치리스트 기능 추가 (add/remove/list/show) ([cb49a15](https://github.com/cpaikr/krx-cli/commit/cb49a1560d3abf2a2c9ca9c3c794ac911c39f4b6))
- 정렬(sort) 및 결과 제한(limit) 기능 추가 ([7515c98](https://github.com/cpaikr/krx-cli/commit/7515c981eadda558bd4c10f72ed7be70f881dc4a))
- 종목 검색 기능 추가 (stock search) ([9f7c562](https://github.com/cpaikr/krx-cli/commit/9f7c5624232faf06c213b189beb31f6f37ec7cc3))
- 종목코드(isuCd) 파라미터 지원 ([a8a7a38](https://github.com/cpaikr/krx-cli/commit/a8a7a38960977229908fc662da7b11e5c909ba27))
- 파일 기반 캐싱 레이어 추가 ([6407278](https://github.com/cpaikr/krx-cli/commit/6407278ed7f8ea2edc30745d2bda6f006c413b3c))
- 필터 표현식 기능 추가 (--filter "FLUC_RT > 5") ([deee528](https://github.com/cpaikr/krx-cli/commit/deee52873a0e418794ce6319e87d2c2a8c16d31d))

### Bug Fixes

- --from/--to 사용 시 --date 필수 요구 제거 ([a97d21b](https://github.com/cpaikr/krx-cli/commit/a97d21b71e0d2c17fb2df0897cc5f377eeb189ef))
...
- CI Node.js 22로 변경 및 린트 에러 수정 ([030b67d](https://github.com/cpaikr/krx-cli/commit/030b67dc95776df12e8d4b4dc469ccc293c6570f))
...
- **contract:** 로컬 환경 파일로 라이브 검사 실행 복구 ([8ecc534](https://github.com/cpaikr/krx-cli/commit/8ecc5346b5543a3e3a23c692611b1bbdf343a995))
...
- isin/단축코드 매칭 로직 통합 및 종목 조회 정상화 ([7636baa](https://github.com/cpaikr/krx-cli/commit/7636baa4e1aa0d2f588a3ed5ef56b7d86124205e))
- isuCd 클라이언트 필터링으로 단일 종목 조회 정상화 ([20299dc](https://github.com/cpaikr/krx-cli/commit/20299dc2ba1e55adfa8b7b6155a5237c8be8cdef))
- mcp 서버 TypeScript 타입 에러 수정 ([bedd41c](https://github.com/cpaikr/krx-cli/commit/bedd41cc206797301e05a9aac03a5c85972aa886))
...
- sdk DNS rebinding 경고 중복 출력 억제 ([d192ad3](https://github.com/cpaikr/krx-cli/commit/d192ad3e66342b9eb045532dea69aa6954876cc3))
...
- tool result truncation 개선 및 isuCd 사용 안내 추가 ([e78553a](https://github.com/cpaikr/krx-cli/commit/e78553a7fa5072be4c2d7f95ff1a1d8b70153b86))
- trusted publishing 위한 node 24 및 repository 필드 추가 ([7cc3418](https://github.com/cpaikr/krx-cli/commit/7cc341888647ef709e5a66bd863f8c134bf62105))
- watchlist show에서 종목 매칭 실패하는 버그 수정 ([25f2f1b](https://github.com/cpaikr/krx-cli/commit/25f2f1b1ba34741ebd2cb7b19bd03daa290dc409))
...
- 포털 검증 기반 응답 필드 스키마 수정 ([4bad087](https://github.com/cpaikr/krx-cli/commit/4bad08726d8ba76cb159b55a47b28a551c069327))
